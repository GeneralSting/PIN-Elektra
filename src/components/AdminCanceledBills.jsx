...
function AdminCustomersBills() {
    ...
    useEffect(() => {
        const readCustomersBills = "http://localhost/pin-elektra/src/php/admin_readCustomersCanceledBills.php" //svi racuni
...
export function ModalShowItems(props) {
    ...
    useEffect(() => {
        ...
        const readReceiptItems = "http://localhost/pin-elektra/src/php/admin_readReceiptItems.php" //svi racuni
