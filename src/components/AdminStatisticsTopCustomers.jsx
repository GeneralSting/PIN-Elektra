...
function AdminStatisticsTopCustomers() {
    ...
    useEffect(() => {
        const readStatisticsArticles = "http://localhost/pin-elektra/src/php/admin_statisticsUniqueCustomers.php"
    ...
    return (
        <div style={{ overflowX: 'hidden', height: '100vh', background: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(255,235,1,0.3984944319524685) 0%, rgba(22,95,198,0.49933476808692223) 100%)' }}>
            <AdminNavbar />
...
export default AdminStatisticsTopCustomers
